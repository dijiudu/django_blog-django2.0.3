...
class Comment(MPTTModel):
    ...
    post = models.ForeignKey(settings.COMMENT_ENTRY_MODEL,on_delete=models.CASCADE, verbose_name='文章')
    parent = TreeForeignKey('self', on_delete=models.CASCADE,blank=True, null=True, verbose_name='父级评论',)
